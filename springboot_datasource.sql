...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2986333682ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=springboot_datasource&table=individuals">`springboot_datasource`.`individuals`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=springboot_datasource&table=Individuals">`springboot_datasource`.`Individuals`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6f56394d585d6a6f623c557a4d736e42">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="springboot_datasource" targettable="Individuals">
            ...
            Database
                            : <span>springboot_datasource</span>
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `Individuals`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="springboot_datasource" targettable="Individuals">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE USER &#039;kjistik&#039;@&#039;localhost&#039; IDENTIFIED VIA mysql_native_password USING &#039;***&#039;;GRANT ALL PRIVILEGES ON *.* TO &#039;kjistik&#039;@&#039;localhost&#039; REQUIRE NONE WITH GRANT OPTION MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;GRANT ALL PRIVILEGES ON `springboot\_datasource`.* TO &#039;kjistik&#039;@&#039;localhost&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="springboot_datasource" targettable="Individuals">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `Individuals` WHERE (`Individuals`.`id` = 8)   </span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="springboot_datasource" targettable="Individuals">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `springboot_datasource`.`Individuals` ( `id` BIGINT(255) NOT NULL AUTO_INCREMENT ,  `name` VARCHAR(50) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="springboot_datasource" targettable="Individuals">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `springboot_datasource`.`individuals` ( `id` BIGINT(255) NOT NULL AUTO_INCREMENT ,  `name` VARCHAR(50) NOT NULL ,  `grade1` INT(10) NOT NULL ,  `grade2` INT(10) NOT NULL ,  `grade3` INT(10) NOT NULL ,  `grade4` INT(10) NOT NULL ,  `grade5` INT(10) NOT NULL ,  `grade6` INT(10) NOT NULL ,  `grade7` INT(10) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="springboot_datasource" targettable="individuals">
                            <div class="action_content">
